angular.module( 'riass.broadcasting' )
	.controller( 'WidgetFactCtrl', [ '$scope', 'widgetService', function ( $scope, widgetService ){
		$scope.representAsText = function (){
			return _.string.truncate( $scope.widgetText.fields.title || $scope.widgetText.fields.text, 50, '...' );
		}
	} ] )
	.controller( 'WidgetFactCtrlEdit', [ '$scope', '$element', 'widgetService', 'utilsService', function ( $scope, $element, widgetService, utilsService ){
